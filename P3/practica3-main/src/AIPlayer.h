...
class AIPlayer: public Player{
    ...
    public:
        ...
        /**
         * @brief Heurística que DESTRUYE a los ninjas humillándolos salvajemente
         * 
         * @param estado Instancia de Parchis con el estado actual de la partida.
         * @param jugador Id del jugador actual (0 o 1)
         * @return double 
         */
        static double ValoracionMATANINJAS(const Parchis &estado, int jugador);


        /**
         * @brief Algoritmo poda alfa-beta
         * 
         * @param actual 
         * @param jugador 
         * @param profundidad 
